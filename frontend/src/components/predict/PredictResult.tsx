 ...
 *
 * Two contract-driven rules live here and nowhere else:
 *   - confidence_band "high" → show result.label; "low" → suppress it and tell
 *     the user to review. The raw score is never rendered (parsed-but-unused).
 *   - meta.demo_mode → a badge flagging the result as illustrative, not real.
 */
...
export function PredictResult({ envelope }: { envelope: PredictEnvelope }) {
  ...
  const isHigh = result.confidence_band === "high";
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                automatically. Check the input and try again, or interpret with
                care.
              </p>
            </div>
          </div>
